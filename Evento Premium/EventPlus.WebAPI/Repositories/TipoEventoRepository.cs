...
public class TipoEventoRepository : ITipoDeEventoRepository
{
    ...
    public void Atualizar(Guid id, TipoEvento tipoEvento)
    {
        ...
        {
            tipoEventoBuscado.Título = tipoEvento.Título;
    ...
    {
        return _context.TipoEventos.OrderBy(tipoevento => tipoevento.Título).ToList();
    }
}
